			...
			<div class="data_box">
                <div class="table_view">
					<el-table v-loading="listLoading" class="data_table" :data="list" border :row-style="{'cursor':'pointer'}"
						...
						<el-table-column label="通知编号" :resizable='true' align="left" header-align="left">
						...
						<el-table-column label="就诊时间" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.jiuzhenshijian}}
							</template>
						</el-table-column>
						<el-table-column label="通知时间" :resizable='true' align="left" header-align="left">
							<template #default="scope">
						...
						<el-table-column label="通知备注" :resizable='true' align="left" header-align="left">
							<template #default="scope">
...
<script setup>
	...
	const addClick = () => {
		router.push('/index/jiuzhentongzhiAdd')
	}
	//判断是否从个人中心跳转
